...
root='/home/mjkim1/.cache/kagglehub/datasets/ashery/chexpert/versions/1'
train_file=os.path.join(root, 'train_only_frontal.csv')
...
with open(os.path.join('chexpert_partition_{}_al_frontal.json'.format(alpha)), 'w') as f:
